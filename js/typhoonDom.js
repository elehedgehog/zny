...
let tyInterval = setInterval(() => {
    ...
    // if(fstAreas === false || (Array.isArray(fstAreas) && fstAreas.length === currentTyNum)) {
        initTySpot();
...
let simObj = {
    ...
    // together: '.together_cusWin',
    // custom: '.cusLonLat_cusWin'
};
let susNavObj = {
 ...
 $('#tyswNav>ul>li').on('click', function() {
    ...
    if($(this).hasClass('a')) {        //清除导航栏选中状态
        ...
        for(let i in susNavObj) {
            if(i === 'typhoon' || i === 'cloud' || i === 'thunder') $(susNavObj[i]).hide();               //先隐藏 台风 云图 雷暴 窗口
        }
...
/*
// 打叉按钮 取消按钮 
$('.together_close,#togetherCancle').click(function(){
    hideSim('.together_cusWin', 1);
})
// 确定按钮
$('#togetherConfirm').click(function(){
    hideSim('.together_cusWin', 1);
})
*/
...
const getBuoyData = () =>{
    ...
    // const buoyUrl = `http://119.29.102.103:8111/buoy?datetime=${time}&element=V22041;V22042;V22043;V22044;V22062;V22062_001;V23001;V23001_001;V23002;V23002_001;V23003;V23003_001;V23004;V23004_001;V23005;V23006;V23007;V23007_001`;
